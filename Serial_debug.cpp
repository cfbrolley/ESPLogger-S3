...
void Serial_Debug::debugdata(unsigned long _timer, float _pressure, float _altitude, float _correctedalt, float _ax, float _ay, float _az, float _gx, float _gy, float _gz, int _state) {
...
void Serial_Debug::debugIMU(int _IMUcode) {
  switch (_IMUcode) {
  case 1:
...
void Serial_Debug::debugSD(int _SDcode) {
  switch (_SDcode) {
  case 1:
